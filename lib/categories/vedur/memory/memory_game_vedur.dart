...
import 'categories/easy_memory_game_vedur.dart';
import 'categories/hard_memory_game_vedur.dart';
import 'categories/medium_memory_game_vedur.dart';

class MemoryGameVedur extends StatelessWidget {
  @override
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => MediumMemoryGameVedur()),
                  );
                },
                child: Container(
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => EasyMemoryGameVedur()),
                  );
                },
                child: Container(
                  padding: const EdgeInsets.all(8),
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => HardMemoryGameVedur()),
                  );
                },
                child: Container(
                  padding: const EdgeInsets.all(8),
