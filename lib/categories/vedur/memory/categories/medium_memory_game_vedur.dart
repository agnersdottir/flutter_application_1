...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Flutter Demo',
      home: MediumMemoryGameVedur(),
    );
  }
}

class MediumMemoryGameVedur extends StatefulWidget {
  const MediumMemoryGameVedur({Key? key}) : super(key: key);

  @override
  _MediumMemoryGameVedurState createState() => _MediumMemoryGameVedurState();
}

class _MediumMemoryGameVedurState extends State<MediumMemoryGameVedur> {
  //setting text style
