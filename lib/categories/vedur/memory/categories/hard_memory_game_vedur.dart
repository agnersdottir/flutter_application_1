...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Flutter Demo',
      home: HardMemoryGameVedur(),
    );
  }
}

class HardMemoryGameVedur extends StatefulWidget {
  const HardMemoryGameVedur({Key? key}) : super(key: key);

  @override
  _HardMemoryGameVedurState createState() => _HardMemoryGameVedurState();
}

class _HardMemoryGameVedurState extends State<HardMemoryGameVedur> {
  //setting text style
