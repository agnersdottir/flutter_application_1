...
import '../../../utils/game_logics_medium_avextir.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Flutter Demo',
      home: MediumMemoryGameAvextir(),
    );
  }
}

class MediumMemoryGameAvextir extends StatefulWidget {
  const MediumMemoryGameAvextir({Key? key}) : super(key: key);

  @override
  _MediumMemoryGameAvextirState createState() =>
      _MediumMemoryGameAvextirState();
}

class _MediumMemoryGameAvextirState extends State<MediumMemoryGameAvextir> {
  //setting text style
