...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Flutter Demo',
      home: MediumMemoryFormGame(),
    );
  }
}

class MediumMemoryFormGame extends StatefulWidget {
  const MediumMemoryFormGame({Key? key}) : super(key: key);

  @override
  _MediumMemoryFormGameState createState() => _MediumMemoryFormGameState();
}

class _MediumMemoryFormGameState extends State<MediumMemoryFormGame> {
  //setting text style
