...
import 'categories/easy_memory_form_game.dart';
import 'categories/hard_memory_form_game.dart';
import 'categories/medium_memory_form_game.dart';

class MemoryFormGame extends StatelessWidget {
  @override
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => MediumMemoryFormGame()),
                  );
                },
                child: Container(
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => EasyMemoryFormGame()),
                  );
                },
                child: Container(
                  padding: const EdgeInsets.all(8),
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => HardMemoryFormGame()),
                  );
                },
                child: Container(
                  padding: const EdgeInsets.all(8),
