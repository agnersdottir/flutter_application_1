...
class HardMemoryGame extends StatefulWidget {
  const HardMemoryGame({Key? key}) : super(key: key);

  @override
  _HardMemoryGameState createState() => _HardMemoryGameState();
}

class _HardMemoryGameState extends State<HardMemoryGame> {
  //setting text style
