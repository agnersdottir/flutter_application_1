...
class _DraggableWidgetState extends State<DraggableWidget> {
  List<CorrectPair> correctPairs = [
    CorrectPair(
        sourceImage: SvgPicture.asset("assets/pairs/Ferningur.svg"),
        targetImage: SvgPicture.asset("assets/pairs/Ferningurdark.svg"),
        id: "sheep"),
    CorrectPair(
        sourceImage: SvgPicture.asset("assets/pairs/halfhringur.svg"),
        targetImage: SvgPicture.asset("assets/pairs/halfhringurdark.svg"),
        id: "horse"),
    CorrectPair(
        sourceImage: SvgPicture.asset("assets/pairs/stjarna.svg"),
        targetImage: SvgPicture.asset("assets/pairs/stjarnadark.svg"),
        id: "dog")
  ];
